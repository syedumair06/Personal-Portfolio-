...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const mailtoLink = `mailto:umairmohiuddin22@gmail.com?subject=Portfolio Contact: ${formData.name}&body=Name: ${formData.name}%0D%0AEmail: ${formData.email}%0D%0A%0D%0AMessage:%0D%0A${formData.message}`;
